...
/////////////////////////////////////////////////////////
////   SYMFONY INTEGRATION SETTINGS /////////////////////

define('SYMFONY_STOP_INSTANCE_DISPATCH', true);
...
$sfDatabase 		= $databaseManager->getDatabase('propel');
...
$dbms	= $dsn[0];
$dsn	= explode(';',$dsn[1]);
$dsn_dbname	= explode('=',$dsn[1]);
$dsn_dbhost	= explode('=',$dsn[0]);
$dbhost 			= $dsn_dbhost[1];
$dbname 			= $dsn_dbname[1];
...
$phpml['FromAddy']       = 'Bogumil';
$phpml['FromName']       = 'news@cre8newmedia.com';
